...
function overview(){
    setValue('data' , db_select_overview());
    return runTemplate('../templates/overview.htm.php');
}

function calender(){
    // if (isset($_REQUEST['calender'])){
    //     setValue('data', $testarr);
    // }
    return runTemplate('../templates/calender.htm.php');
}
